#!/usr/bin/env bash
#
# vm-create.sh - Creates a disposable Debian VM via COW clone + cloud-init
#
# Usage: ./vm-create.sh <name> <ram_mb> <vcpus>
# Example: ./vm-create.sh webtest 2048 2
#
set -euo pipefail
...
OS_VARIANT="debian12"   # no debian13 profile yet in osinfo-db
